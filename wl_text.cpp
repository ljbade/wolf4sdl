...
// wait for time
//
        SDL_Delay((picdelay*100)/7);

//
// draw pic
//
        VWBL_DrawPic (picx&~7,picy,picnum);
}
...
void HandleCommand (void)
{
    ...
    switch (toupper(*++text))
    {
        case 'B':
            ...
            VWBL_Bar(picx,picy,picwidth,picheight,BACKCOLOR);
            RipToEOL();
            break;
        case ';':               // comment
            RipToEOL();
...
//
    ...
    VWB_Bar (vidbuf, backgroundPitch, 0,0,320,200,BACKCOLOR);
    VWB_DrawPic (vidbuf, backgroundPitch, 0,0,H_TOPWINDOWPIC);
    VWB_DrawPic (vidbuf, backgroundPitch, 0,8,H_LEFTWINDOWPIC);
    VWB_DrawPic (vidbuf, backgroundPitch, 312,8,H_RIGHTWINDOWPIC);
    VWB_DrawPic (vidbuf, backgroundPitch, 8,176,H_BOTTOMINFOPIC);
...
#endif
{
    ...
    VWBL_Bar (0,0,320,200,BACKCOLOR);
    CacheLayoutGraphics ();
    #endif
